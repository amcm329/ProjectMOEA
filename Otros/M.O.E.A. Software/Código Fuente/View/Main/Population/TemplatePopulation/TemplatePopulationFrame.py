...
class TemplatePopulationFrame(tk.Frame):
      """ 
          ...
          for technique_name in self.__techniques.keys():     
              ...
              for element in technique_parameters:
                  ...
                  #será activada o no.
                       ...
                       provisional_checkbutton_variable = tk.StringVar() 
      ...
      def grid_widgets(self):
          ...
          self.__option_menu_label.grid(row = self.row_position,column = 0,padx = (1,8),pady = (9,15),sticky = tk.E)
          self.__option_menu.grid(row = self.row_position,column = 1,padx = (1,1),pady = (9,15),sticky = tk.W)
          self.row_position += 1
          self.__separator.grid(row = self.row_position,column = 0,columnspan = 2,pady = (20,1),sticky = tk.W + tk.E)
          self.row_position += 1
          self.__parameters_label.grid(row = self.row_position,column = 0,columnspan = 2,pady = (8,13),sticky = tk.N + tk.S)
          self.row_position += 1

...
class ObjectiveFunctionFrame(tk.Frame):
      ...
      def __init__(self,parent,features):
          ...
          #tendra al FunctionFrame como hijo.
          ...
          #cuando el número de funciones insertadas excede el tamaño del Frame. Este es el número
          #máximo de funciones tolerado ANTES de insertar la barra de desplazamiento.
          self.__row_limit = 10
          ...
          #Ahora se crea el FunctionFrame cuyo Padre será el Canvas.
          self.__function_frame = FunctionFrame(self.__canvas,features)  

          #Se le añade un evento al FunctionFrame que activará la barra de desplazamiento cada vez que
          #el número de casillas sobrepase el límite del Frame.
          self.__function_frame.bind("<Configure>",self.__activate_scroll)

          #Se coloca el Frame dentro del Canvas.
          self.__function_frame.pack(side = tk.TOP,fill = tk.X,expand = True)

          #La siguiente instrucción le indica al Canvas que cree una ventana que contenga al 
          #FunctionFrame y que se desplazará hacia abajo cuando se quiera 
          #hacer desplazamiento con la barra.
          self.__canvas.create_window((110,0),window = self.__function_frame,anchor = tk.NW)
          ...
          self.__canvas.grid(row = 0,column = 0,columnspan = 2,sticky = tk.N + tk.S + tk.W + tk.E)
      ...
      def __activate_scroll(self,event):
          ...
          current_rows = self.__function_frame.get_current_elements()
      ...
      def restore_settings(self):
          ...
          self.__function_frame.restore_settings() 

          #Adicional a eso, se inserta una casilla limpia de función objetivo.
          self.__function_frame.insert_function()
      ...
      def insert_mop_example(self,functions):
          ...
          self.__function_frame.insert_mop_example(functions)
      ...
      def get_information(self):
          ...
          return self.__function_frame.get_information()

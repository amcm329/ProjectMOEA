...
es meramente una condición que indica que se ha alcanzado un 
...
Presión Selectiva - consiste en la implantación de algún tipo de catalizador en una población con la finalidad de 
obtener al mejor individuo con un número pequeño de generaciones. 
Especiación - este es un proceso en el cual, a partir de una 
población original se derivan dos o más hijas, las cuales con el 
tiempo, a pesar de haber surgido del mismo punto de partida, pueden
compartir apenas pocas características en común. Las razones de dicho
proceso pueden variar, ya sea desde una barrera natural (río, erupción, terremoto) hasta
una causa artificial (cruza selectiva de perros). 
Epístasis - se trata de un fenómeno en el cual (poner referencia) un gen puede suprimir o enmascarar a otro,
